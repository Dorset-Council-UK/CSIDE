...
namespace CSIDE.Data.Migrations
{
    ...
    [Migration("20260813131105_AddOrganisationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("survey_sequence", "cside");
            ...
            modelBuilder.Entity("CSIDE.Data.Models.DMMO.CouncilDecisionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_dmmo_council_decision_types");

                    b.ToTable("dmmo_council_decision_types", "cside");
                });
            ...
            modelBuilder.Entity("CSIDE.Data.Models.DMMO.DMMOCouncilDecision", b =>
                {
                    b.Property<int>("CouncilDecisionId")
                        .HasColumnType("integer")
                        .HasColumnName("council_decision_id");

                    b.Property<int>("DMMOApplicationId")
                        .HasColumnType("integer")
                        .HasColumnName("dmmo_application_id");

                    b.Property<int>("CouncilDecisionTypeId")
                        .HasColumnType("integer")
                        .HasColumnName("council_decision_type_id");
                    ...
                    b.HasKey("CouncilDecisionId", "DMMOApplicationId")
                        .HasName("pk_dmmo_council_decisions");

                    b.HasIndex("CouncilDecisionTypeId")
                        .HasDatabaseName("ix_dmmo_council_decisions_council_decision_type_id");

                    b.HasIndex("DMMOApplicationId")
                        .HasDatabaseName("ix_dmmo_council_decisions_dmmo_application_id");

                    b.ToTable("dmmo_council_decisions", "cside");
                });
            ...
            modelBuilder.Entity("CSIDE.Data.Models.DMMO.DMMOMedia", b =>
                {
                    ...
                    b.HasKey("DMMOApplicationId", "MediaId")
            ...
            modelBuilder.Entity("CSIDE.Data.Models.Shared.Organisation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CSIDE.Data.Models.Surveys.Survey", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseSequence(b.Property<int>("Id"), "survey_sequence", "cside");
            ...
            modelBuilder.Entity("CSIDE.Data.Models.DMMO.DMMOCouncilDecision", b =>
                {
                    b.HasOne("CSIDE.Data.Models.DMMO.CouncilDecisionType", "CouncilDecisionType")
                        .WithMany()
                        .HasForeignKey("CouncilDecisionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_dmmo_council_decisions_dmmo_council_decision_types_council_");

                    b.HasOne("CSIDE.Data.Models.DMMO.DMMOApplication", "DMMOApplication")
                        .WithMany("DMMOCouncilDecisions")
                        .HasForeignKey("DMMOApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_dmmo_council_decisions_dmmo_application_dmmo_application_id");

                    b.Navigation("CouncilDecisionType");
            ...
            modelBuilder.Entity("CSIDE.Data.Models.DMMO.DMMOApplication", b =>
                {
                    ...
                    b.Navigation("DMMOCouncilDecisions");
