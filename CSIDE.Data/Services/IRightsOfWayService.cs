...
namespace CSIDE.Data.Services
{
    public interface IRightsOfWayService
    {
        ...
        Task<IReadOnlyCollection<ClosedRoutesViewModel>> GetClosedRoutes(CancellationToken ct = default);
        Task<IReadOnlyCollection<ClosedRoutesViewModel>> GetClosedRoutesForTeam(List<int> teamId, CancellationToken ct = default);
