...
namespace CSIDE.Components.Pages.Surveys.BridgeSurveys
{
        ...
        ISettingsService settingsService)
    {
        ...
        public void OnRadioChange()
        {
            ...
            {
                ShowBeamTimbersSection = Survey.BeamMaterialId.HasValue && Materials.Where(m => m.Id == Survey.BeamMaterialId).Single().IsWood;
                ShowDeckingBoardsSection = Survey.DeckingMaterialId.HasValue && Materials.Where(m => m.Id == Survey.DeckingMaterialId).Single().IsWood;
                ShowHandrailTimbersSection = Survey.HandrailMaterialId.HasValue && Materials.Where(m => m.Id == Survey.HandrailMaterialId).Single().IsWood;
                ShowHandrailPostsTimbersSection = Survey.HandrailPostsMaterialId.HasValue && Materials.Where(m => m.Id == Survey.HandrailPostsMaterialId).Single().IsWood;
