...
namespace CSIDE.Migrations
{
    ...
    [Migration("20250617160748_UpdatePPOColumns")]
    partial class UpdatePPOColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CSIDE.Data.Models.PPO.PPOIntent", b =>
                {
                    ...
                    b.Property<int>("PPOApplicationIntentId")
                        .HasColumnType("integer");

                    b.HasKey("ApplicationId", "IntentId");

                    b.HasIndex("PPOApplicationIntentId");
            ...
            modelBuilder.Entity("CSIDE.Data.Models.PPO.PPOIntent", b =>
                {
                    ...
                    b.HasOne("CSIDE.Data.Models.PPO.ApplicationIntent", "PPOApplicationIntent")
                        .WithMany()
                        .HasForeignKey("PPOApplicationIntentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PPOApplication");

                    b.Navigation("PPOApplicationIntent");
                });
